	...
	: QDialog{ parent }
{
	...
	Sections summaryColorCodeSections = {
		...
		{ "At least one Stream/Channel is connected but no audio can flow (different domain, reservation error, ...)", Model::IntersectionData::Type::Entity_SingleStream, Model::IntersectionData::State::Connected, Model::IntersectionData::Flags{ Model::IntersectionData::Flag::WrongDomain }, false, "Check links between switches, check AVB is enabled on switches" },
	...
	Sections connectionColorCodeSections = {
		...
		{ "Connected but no audio can flow (different domain, reservation error, ...)", Model::IntersectionData::Type::SingleStream_SingleStream, Model::IntersectionData::State::Connected, Model::IntersectionData::Flags{ Model::IntersectionData::Flag::WrongDomain }, false, "Check links between switches, check AVB is enabled on switches" },
