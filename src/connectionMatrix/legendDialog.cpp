	...
	: QDialog{ parent }
{
	...
	Sections summaryColorCodeSections = {
		...
		{ "At least one Stream/Channel is connected but at least one Network Interface is down", Model::IntersectionData::Type::Entity_Entity, Model::IntersectionData::State::Connected, Model::IntersectionData::Flags{ Model::IntersectionData::Flag::InterfaceDown, Model::IntersectionData::Flag::WrongDomain }, false, "" },
