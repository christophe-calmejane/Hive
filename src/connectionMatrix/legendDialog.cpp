	...
	: QDialog{ parent }
{
	...
	Sections summaryColorCodeSections = {
		...
		{ "All Streams/Channels are connected but at least one Network Interface is down", Model::IntersectionData::Type::Entity_Entity, Model::IntersectionData::State::Connected, Model::IntersectionData::Flags{ Model::IntersectionData::Flag::InterfaceDown, Model::IntersectionData::Flag::WrongDomain }, false, "" },
