...
public:
	...
	*/
	...
	Q_SIGNAL void streamOutputCountersChanged(la::avdecc::UniqueIdentifier const entityID, la::avdecc::entity::model::StreamIndex const streamIndex, la::avdecc::controller::model::StreamOutputCounters const& counters);
	...
	Q_SIGNAL void avbInterfaceErrorCounterChanged(la::avdecc::UniqueIdentifier const entityID, la::avdecc::entity::model::DescriptorIndex const descriptorIndex, la::avdecc::entity::AvbInterfaceCounterValidFlags const flags);
	Q_SIGNAL void clockDomainErrorCounterChanged(la::avdecc::UniqueIdentifier const entityID, la::avdecc::entity::model::DescriptorIndex const descriptorIndex, la::avdecc::entity::ClockDomainCounterValidFlags const flags);
	...
	Q_SIGNAL void streamOutputErrorCounterChanged(la::avdecc::UniqueIdentifier const entityID, la::avdecc::entity::model::DescriptorIndex const descriptorIndex, la::avdecc::entity::StreamOutputCounterValidFlags const flags);
}; // namespace avdecc
