...
QVariant Model::data(QModelIndex const& index, int role) const
{
	...
	if (role == Qt::DisplayRole)
	{
		switch (name)
		{
			...
			case Name::Pink: return "Pink";
			case Name::Purple: return "Purple";
			case Name::DeepPurple: return "Deep Purple";
			case Name::Indigo: return "Indigo";
			case Name::Blue: return "Blue";
			case Name::LightBlue: return "Light Blue";
			case Name::Cyan: return "Cyan";
			case Name::Teal: return "Teal";
			case Name::Green: return "Green";
			case Name::LightGreen: return "Light Green";
			case Name::Lime: return "Lime";
			case Name::Yellow: return "Yellow";
			case Name::Amber: return "Amber";
			case Name::Orange: return "Orange";
			case Name::DeepOrange: return "Deep Orange";
			case Name::Brown: return "Brown";
			case Name::Gray: return "Gray";
			case Name::BlueGray: return "Blue Gray";
			default:
				assert(false);
				return "Invalid";
		}
